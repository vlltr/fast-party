...
This repository includes a technical test for Golden State Assembly, LLC.
[Postman Documentation](https://documenter.getpostman.com/view/17238355/2s93eU2ET4)
...
```bash
git clone git@github.com:vlltr/fast-party.git
cd fast-party
```
